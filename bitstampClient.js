...
class BitstampClient {
    ...
    constructor(profile) {
        ...
        this.api_key = this.profile.key
        this.api_secret = this.profile.secret

        this.currency = profile.defaultCurrency.toLowerCase() // default currency
        this.crypto = profile.defaultCrypto.toLowerCase() // default crypto
        this.setUrls()
        this.simulate = profile.simulate
    }
